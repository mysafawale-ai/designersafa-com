...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      <DynamicContactForm location="India" domain="designersafa.com" />
      <GallerySection />
      <DynamicServicesSection location="India" domain="designersafa.com" />
      <DynamicFooter location="India" domain="designersafa.com" />
      <WhatsAppFloat />
    </main>
  )
}
